...
def main():
    ...
    out.append(
        ...
        "built-together lanes. Decklists are known for all 129 decks — "
        "five (Dom, aidybaby, Rob, Rocketman, tenderdrafter) are "
        "transcribed from posted deck images, each validated "
        "card-for-card against the player's 45 picks. "
